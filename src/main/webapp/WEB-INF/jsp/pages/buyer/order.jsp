    ...
    <c:choose>
        <c:when test="${not empty order.productIts and not empty orderItem}">
                        ...
                        <div class="panel panel-info">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-2">
                                            <button type="button" class="btn btn-link btn-xs">
                                                <form action="<c:url value="/buyer/order/remove.html?productId=${product.id}"/>"
                                                      method="post">
                            ...
                            <div class="panel-footer">
                                <div class="row text-center">
                                    ...
                                    <div class="col-xs-3">
                                        <form action="<c:url value="/buyer/order/submit.html"/>" method="get">
            ...
            <div class="card-footer">
                <form action="<c:url value="/products/list.html"/>" method="get">
