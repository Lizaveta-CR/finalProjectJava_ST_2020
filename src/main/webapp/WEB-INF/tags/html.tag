...
<%--&lt;%&ndash;<%@attribute name="title" required="true" rtexprvalue="true" type="java.lang.String" %>&ndash;%&gt;--%>
...
<%--    &lt;%&ndash;    <TITLE>Библиотека - ${title}</TITLE>&ndash;%&gt;--%>
<%--    <c:url value="/main.css" var="cssUrl"/>--%>
<%--    <LINK rel="stylesheet" type="text/css" href="${cssUrl}">--%>
<%--    &lt;%&ndash;    <c:url value="/js" var="javascriptUrl"/>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <SCRIPT type="text/javascript" src="${javascriptUrl}/main.js"></SCRIPT>&ndash;%&gt;--%>
