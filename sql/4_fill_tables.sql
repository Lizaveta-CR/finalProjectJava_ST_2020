...
VALUES (1, 3, 'Fender CD-60S Natural', true,
       ...
       (3, 7, 'Cervini HV-100 1/2', true,
        'Верхняя дека этой скрипки изготовлена из ели, а нижняя дека, обечайка и шейка - из клена. Колки сделаны из твердых пород древесины. Удобный подбородник модели Stradivarius также выполнен из твердых пород древесины. Подгрифник из легкого композитного материала с четырьмя машинками для микроподстройки гарантирует идеальное интонирование.',
        'Cervini.jpg', 257.40),
       (4, 6, 'Cort Action Bass V Plus TR', true,
        'Корпус инструмента сделан из тополя, а гриф выполнен из клена и крепится на болтах. Накладка на гриф - палисандровая (24 лада), инкрустированная белыми точками. В бас-гитаре установлены датчики Powersound вида J в бридже и неке, обеспечивающие сбалансированное звучание. Электроника представлена 2-полосным эквалайзером, регулировками громкости и тона. Бридж гитары - EB6(5). Колки - литые, фурнитура - хромовая.',
        'bas.jpg', 564.20),
       (5, 6, 'Homage HEB710RD', true,
        'Корпус гитары с двумя вырезами выполнен из массива твердой древесины. Гриф изготовлен из клена . Накладка с 21 ладом сделана из палисандра. За строй бас-гитары отвечает колковая механика открытого типа.',
        'bas.jpg', 564.20),
       (6, 7, 'Brahner BVC-370/MPK 4/4', true,
        'Верхняя дека скрипки выполнена из ели, нижняя дека, обечайка и шейка - из клена. Стильный внешний вид дополняют гриф, колки, подбородник и подгрифник черного цвета. На скрипке установлены 4 машинки для точной подстройки.',
        'Cervini.jpg', 294.50),
       (7, 8, 'Cremona SC-165 4/4', true,
        'Несмотря на то, что эта модель относится к студенческой серии, она настолько хороша, что подойдет для игры в оркестре. Великолепный звук и эргономика этого инструмента ускорит прогресс обучения любого добросовестного студента музыкального учебного заведения. Верхняя дека сделана из массива отборной ели, нижняя дека и обечайки сделаны из массива отборного клена. Корпус имеет красивую защитную окантовку.',
        'cello.jpg', 2612.69);
